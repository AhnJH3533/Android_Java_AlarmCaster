...
public class MainActivity extends AppCompatActivity {
    ...
    private void setAlarm() {
        // 알람 시간 설정
        this.calendar.set(Calendar.HOUR_OF_DAY, timePicker.getHour());
        this.calendar.set(Calendar.MINUTE, timePicker.getMinute());
        ...
        Toast.makeText(this, "새알람 : " + format.format(calendar.getTime()), Toast.LENGTH_LONG).show();
    }
